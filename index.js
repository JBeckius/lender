...
let BookDAO = require('./DAOs/books').BookDAO;
...
// });
MongoClient.connect('mongodb://localhost:27017/libraryApp', function(err, db) {
  "use strict";

  assert.equal( null, err);
  console.log("Successfully connected to MongoDB");

  var books = new BookDAO(db);
